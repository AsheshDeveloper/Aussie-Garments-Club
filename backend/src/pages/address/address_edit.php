                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <p class="card-subtitle card-subtitle-dash">Create a new address</p>
                                        </div>
                                        <div>
                                            <a href="../address/address.php"
                                                class="btn btn-primary text-white mb-0 me-0" type="button">
                        ...
                        foreach($success as $s){ ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="street_address"
                                            id="street_address" value="<?php echo $street_address ?>" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="postal_code" id="postal_code"
                                            value="<?php echo $postal_code ?>" required>
                                    </div>
                                    <a href="../address/address.php" class="btn btn-primary">Back</a>
