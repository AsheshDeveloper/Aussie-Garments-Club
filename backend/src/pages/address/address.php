                ...
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      ...
                      <div>
                        <a href="../address/address_create.html" class="btn btn-primary text-white mb-0 me-0" type="button"
                          ><i class="mdi mdi-plus me-1"></i>New Address</a
                        >
                      </div>
                    </div>
                        ...
                        <tbody>
                          <tbody>
                            ...
                            <tr class="trow">
                                ...
                                <td>
                                    <a class="btn btn-inverse-dark btn-rounded btn-icon" href="../address/address_edit.php?id=<?php echo $address_id; ?>"><i class="mdi mdi-pencil"></i></a>
                                    <a class="btn btn-inverse-danger btn-rounded btn-icon" href="../address/address_delete.php?id=<?php echo $address_id; ?>"><i class="mdi mdi-delete"></i></a>
                                </td>
                            </tr>
