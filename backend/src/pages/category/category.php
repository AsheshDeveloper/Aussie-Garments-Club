                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        if(!empty($_SESSION['message'])) { ?>
                                        ...
                                        <div>
                                            <a href="../category/category_create.php"
                                                class="btn btn-primary text-white mb-0 me-0" type="button"><i
                                                    class="mdi mdi-plus me-1"></i>New Category</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-inverse-dark btn-rounded btn-icon"
                                                            href="../category/category_edit.php?id=<?php echo $category_id; ?>"><i
                                                                class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-inverse-danger btn-rounded btn-icon"
                                                            href="../category/category_delete.php?id=<?php echo $category_id; ?>"><i
