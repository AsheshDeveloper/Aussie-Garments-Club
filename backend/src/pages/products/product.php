                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="pages">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="../products/product.php">Product</a></li>
            ...
            <div class="main-panel">
                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <p class="card-subtitle card-subtitle-dash">List of all product</p>
                                        </div>
                                        <div>
                                            <a href="../products/product_create.php"
                                                class="btn btn-primary text-white mb-0 me-0" type="button"><i
                                                    class="mdi mdi-plus me-1"></i>New Product</a>
                                        </div>
                                    </div>
                ...
                ?>
                                                <tr class="trow">
                                                    ...
                                                    <td><?php echo $size; ?></td>
                                                    <td><a class="btn btn-inverse-dark btn-rounded btn-icon"
                                                            href="../products/product_edit.php?id=<?php echo $product_id; ?>"
                                                            class="btn btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                    </td>
                                                    <td><a class="btn btn-inverse-danger btn-rounded btn-icon"
                                                            href="../products/product_delete.php?id=<?php echo $product_id; ?>"
