        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                  ...
                  ?>
                                    <form class="p-3 rounded" style="width:450px;" action="" method="post"
                ...
                foreach($success as $s){ ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="product_name"
                                                id="product_name" value="<?php echo $product_name ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="description" class="form-label">Description</label>
                                            <textarea type="text" class="form-control" name="description"
                                                id="description" value="<?php echo $description ?>"> </textarea>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="stock_quantity"
                                                id="stock_quantity" required value="<?php echo $stock ?>">
                                        </div>
                                        <div class="mb-3">
                                            <select class="form-select" aria-label="Select the main category"
                                                name="main_category">
                                                <?php
