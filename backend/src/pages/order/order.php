            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="../order/order.php">Customer Order</a></li>
                ...
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      <div>
                        <h4 class="card-title card-title-dash">Customer Order</h4>
                        <p class="card-subtitle card-subtitle-dash">List of all customer orders</p>
                      </div>
                    ...
                    $fetch = "SELECT * FROM `order`";
                    if ($result = $connect ->query($fetch)) {
                        //print_r($row);
                        while ($row = $result -> fetch_assoc()) { 
                            $order_numner = $row['OrderNumber'];
                            $customer_name = $row['CustomerName'];
                            $customer_email = $row['CustomerEmail'];
                            $order_status = $row['OrderStatus'];
                            $total_amount = $row['TotalAmount'];
                            $order_created_date = $row['CreatedAt'];

                ?>                    
                <tr class="trow">
                    <td><?php echo $order_numner; ?></td>
