                            ...
                            <div class="card card-rounded">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Size</h4>
                                            <p class="card-subtitle card-subtitle-dash">List of all size</p>
                                        </div>
                                        <div>
                                            <a href="../size/size_create.html"
                                                class="btn btn-primary text-white mb-0 me-0" type="button"><i
                                                    class="mdi mdi-plus me-1"></i>New Size</a>
                                        </div>
                                        <?php
                      if(!empty($_SESSION['message'])) { ?>
                          ...
                          ?>
                                                <tr class="trow">
                                                    ...
                                                    <td><a href="../size/size_edit.php?id=<?php echo $size_id; ?>"
                                                            class="btn btn-primary">Edit</a></td>
                                                    <td><a href="../size/size_delete.php?id=<?php echo $size_id; ?>"
