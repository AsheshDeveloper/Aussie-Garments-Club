                ...
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      ...
                      <div>
                        <a href="../brands/brands_create.php" class="btn btn-primary text-white mb-0 me-0" type="button"
                          ><i class="mdi mdi-plus me-1"></i>New Brand</a
                        >
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-hover">
                        ...
                        <tr class="trow">
                            ...
                            <td><a class="btn btn-inverse-dark btn-rounded btn-icon" href="../brands/brand_edit.php?id=<?php echo $brand_id; ?>" ><i class="mdi mdi-pencil"></i></a></td>
                            <td><a class="btn btn-inverse-dark btn-rounded btn-icon" href="../brands/brand_delete.php?id=<?php echo $brand_id; ?>" ><i class="mdi mdi-delete"></i></a></td>
                        </tr>
