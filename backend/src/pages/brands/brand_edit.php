                ...
                <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <p class="card-subtitle card-subtitle-dash">Create a New Brand</p>
                                        </div>
                                        <div>
                                            <a href="../brands/brand.php" class="btn btn-primary text-white mb-0 me-0"
                                                type="button"><i class="mdi mdi-arrow-left me-1"></i>Go Back</a>
                                        </div>
                                    </div>
                                    <!--  -->
                                </div>
                    ...
                    ?>
                            ...
                            foreach($success as $s){ ?>
                                    ...
                                    <a href="../brands/brand.php" class="btn btn-primary">Back</a>
