                ...
                <form class="mt-5 mb-5" action="" method="post">
                  ...
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="first_name">First Name <span class="text-danger">*</span></label>
                    </div>
                    <input type="text" class="form-control" name="first_name" id="first_name" placeholder="eg: Harry" required />
                  </div>
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="middle_name">Middle Name</label>
                    </div>
                    <input type="text" class="form-control" name="middle_name" id="middle_name" placeholder="eg: Harry"/>
                  </div>
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="last_name">Last Name <span class="text-danger">*</span></label>
                    </div>
                    <input type="text" class="form-control" name="last_name" id="last_name" placeholder="eg: jaggard" required />
                  </div>
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="contact">Contact Number<span class="text-danger">*</span></label>
                    </div>
                    <input type="text" class="form-control" name="contact" id="contact" placeholder="eg: +6189876756" required />
                  </div>
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="email"> Email <span class="text-danger">*</span></label>
                    </div>
                    <input type="email" class="form-control" name="email" id="email" placeholder="eg: someone@somthing.com" required />
                  </div>
                  <div class="mb-3">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="password">Password<span class="text-danger">*</span></label>
                    </div>
                  ...
                  <div class="mb-3">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="confirm_password">Confirm Password<span class="text-danger">*</span></label>
                    </div>
                    <div class="input-group">
                      <input type="confirm_password" class="form-control" name="confirm_password" id="confirm_password" placeholder="**********" required />
                  ...
                  <a href="" class="mb-5 mt-5 google-login">
                    <img class="google-icon" src="../images/assets/google ICon.png" alt="Google Logo" /> Signin with Google
                  </a>
                </form>
                <small class="mt-5">Already Have an account? <a href="../pages/login.html">Log In</a></small>
              </div>
            </div>
          </div>
        </div>
