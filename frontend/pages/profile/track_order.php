...
<body>
    ...
    <div class="container-fluid">
        <div class="container mt-5">
            <h5 class="mb-3">
                Your Orders <span><i class="fa-solid fa-truck text-primary"></i></span>
            </h5>
            <table class="table">
                <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                                data-bs-target="#viewOrder"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>1</td>
    ...
    <!-- Filter Modal -->
    <div class="modal modal-lg fade product-filter-modal" id="viewOrder" tabindex="-1" aria-labelledby="viewOrderLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-end">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewOrderLabel">Order Informations</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="alert alert-secondary" role="alert">Your Order shipped from china</div>
                            <div class="alert alert-secondary" role="alert">Your Order is out for delivery</div>
                            <div class="alert alert-success" role="alert">Your Order is delivered in <strong> 6 east
                                    street 1107</strong></div>
                        </div>
                    </div>
                </div>
            </div>
