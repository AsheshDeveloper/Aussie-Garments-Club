                ...
                <form class="mt-5 mb-5" action="" method="post">
                  ...
                  <div class="mb-4">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="email">Email or Phone <span class="text-danger">*</span></label>
                    </div>
                    <input type="email" class="form-control" name="email" id="email" placeholder="eg: someone@somthing.com" required />
                  </div>
                  <div class="mb-3">
                    <div class="d-flex align-items-left">
                      <label class="form-check-label mb-1" for="rememberMe">Password <span class="text-danger">*</span></label>
                    </div>
                  ...
                  <a href="" class="mb-5 mt-5 google-login">
                    <img class="google-icon" src="../images/assets/google ICon.png" alt="Google Logo" /> Login with Google
                  </a>
                </form>
                <small class="mt-5">Don't have an account yet? <a href="../Pages/signup.html">Sign Up</a></small>
              </div>
            </div>
          </div>
        </div>
