...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-md-6">
            <div class="description-container">
              ...
              <div class="button-group mt-4">
                ...
                <button type="button" id="popoverButton" class="btn btn-outline-primary me-4 px-4 py-2">Add To Cart</button>
              </div>
              ...
              <div class="click-and-collect mt-4 p-3">
                <div class="">
                  ...
                  shopping at
                  <span>
                    <a href="#" id="openModal" data-bs-toggle="modal" data-bs-target="#locationModal">Lidcombe</a>
                  </span>
                </div>
                <div class="clickable-div mt-2">
                  <div style="float: right"><i class="fas fa-chevron-down"></i></div>
                  <h6 class="">Click and Collect</h6>
                  <span>Collect win 2 - 7 days</span>
                  <div class="description mt-2 text-muted" style="display: none">
                    Items unavailable at this store are transferred from another store. Please wait for an email confirming the item is
                    ready to collect.
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="d-flex align-items-center">
                <button class="btn btn-primary me-4 py-2" data-bs-toggle="modal" data-bs-target="#writeReviewModal">Write a Review</button>
                <div class="dropdown">
                  <button
                    class="btn btn-outline-primary dropdown-toggle py-2"
                    type="button"
            ...
            <div class="review">
              <div class="d-flex align-items-center">
                <img src="../images/profile/stefan-stefancik-QXevDflbl8A-unsplash.jpg" alt="User Image" class="user-image me-2" />
                <div class="mt-3">
              ...
              <p class="mt-2 text-muted">
                Request dry cleaning at specialist cleaners only, do not bleach. Do not tumble dry, this is the random text iron at low
                temperature.
              </p>
            </div>
            <div class="review">
    ...
    <div class="container mt-5 mb-5 suggestion-container">
      <div class="row">
        <div class="col-md-6">
          <h5 class="mb-4">Suggestion for you <img src="../images/assets/refresh 1.png" alt="Suggestion" /></h5>
