...
$google_oauth_client_id = isset($_ENV['GOOGLE_OAUTH_CLIENT_ID']) ? $_ENV['GOOGLE_OAUTH_CLIENT_ID'] : '';
$google_oauth_client_secret = isset($_ENV['GOOGLE_OAUTH_CLIENT_SECRET']) ? $_ENV['GOOGLE_OAUTH_CLIENT_SECRET'] : '';
$google_oauth_redirect_uri = 'http://localhost/Aussie-Garments-Club/frontend/pages/authentication/google-oauth.php';
