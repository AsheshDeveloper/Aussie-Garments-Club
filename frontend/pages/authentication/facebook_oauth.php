<?php
session_start();
$facebook_oauth_app_id = '1447951259139395';
$facebook_oauth_app_secret = '94a753a3d546dd5fc97ea5679bc050b1';
// Must be the direct URL to the facebook-oauth.php file
$facebook_oauth_redirect_uri = 'http://localhost/Aussie-Garments-Club/frontend/pages/authentication/facebook_oauth.php';
