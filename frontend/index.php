      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom-top">
        <div class="container">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./pages/user_profile.html">Guest</a>
            </li>
          </ul>
          <?php } ?>
          <?php if(!empty($_SESSION['username'])){ ?>
            <ul class="navbar-nav ms-auto">
            <li class="nav-item"><p>Welcome</p></li>
            
            <li class="nav-item">
              <a class="nav-link" href="./pages/user_profile.html">Log out</a>
            </li>
          </ul>
          <?php } ?>
        </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="./images/slider/clark-street-mercantile-qnKhZJPKFD8-unsplash.jpg" class="d-block w-100" alt="First slide" />
                </div>
                <div class="carousel-item">
                  <img src="./images/slider/clark-street-mercantile-P3pI6xzovu0-unsplash.jpg" class="d-block w-100" alt="Second slide" />
                </div>
                <div class="carousel-item">
                  <img src="./images/slider/francis-duval-IFMbJCtKTjc-unsplash.jpg" class="d-block w-100" alt="Third slide" />
                </div>
                <div class="carousel-item">
                  <img src="./images/slider/francis-duval-IFMbJCtKTjc-unsplash.jpg" class="d-block w-100" alt="Third slide" />
                </div>
